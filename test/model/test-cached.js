...
var should = require('should'),
    JGL = require('../../'),
    MemoryJGLModel = JGL.Model.Memory,
    CachedJGLModel = JGL.Model.Cached;

describe('CachedJGLModel', function () {
    ...
    beforeEach(function () {
        ...
        cacheDoc = {},
        proxy = new MemoryJGLModel(doc);
        cache = new MemoryJGLModel(cacheDoc);
        pe = new CachedJGLModel({ cache: cache, proxy: proxy });
    });
